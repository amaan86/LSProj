<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin-Dash.aspx.cs" Inherits="LSProject.Admin_Dash" %>
...
<body>
 <form id="form1" runat="server">
        ...
        <nav class="nav" id="nav">
            ...
            <ul class="imp-links">
                <li class="links"><asp:LinkButton ID="home" runat="server" CssClass="active">Home</asp:LinkButton></li>
        ...
        <div class="content">
            <div class="basicinfo">
                <asp:Button ID="add_book" runat="server" CssClass="searchButton" Text="Add Book" OnClick="add_book_Click" />
                <h3>Admin Panel</h3>
                <hr class="break"/>
            ...
            <div class="result">
                ...
                <asp:GridView ID="GridView1" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" AutoGenerateColumns="False" OnRowDeleting="OnRowDeleting" OnRowDataBound="OnRowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Remove Book" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" Text=""></asp:LinkButton>
                            </ItemTemplate>
                            <ControlStyle CssClass="fa fa-trash delicon" />
                        </asp:TemplateField>
                    </Columns>
